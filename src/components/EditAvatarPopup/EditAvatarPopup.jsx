...
export default function EditAvatarPopup({isOpen, onClose, onUpdateAvatar, isLoaderMessage}) {
    const input = useRef()
    ...
    return (
        ...
        />
        <span id="error-avatar" className="popup__error-message">{errors.avatar}</span>
        </PopupWithForm>
    )
}